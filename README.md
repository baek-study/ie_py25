...
## [14주차 강의&nbsp;-&nbsp;파일](https://github.com/baek-study/ie_py25/blob/main/source/week14_mju.ipynb)
...
### [파일 읽기](https://github.com/baek-study/ie_py25/blob/main/source/week14_mju.ipynb)
<ul>
...
### [파일쓰기](https://github.com/baek-study/ie_py25/blob/main/source/week14_mju.ipynb)
<ul>
<li>write() : 모든 내용을 하나의 문자열로 반환 </li>
<li>writelines() : 문자열 리스트를 쓰기 </li>
</ul>

### [데이터 정제](https://github.com/baek-study/ie_py25/blob/main/source/week14_mju.ipynb)
<ul>
<li>문자열.strip() : 공백문자(빈칸, \n 등) 제거 </li>
<li>문자열.split(구분자) : 구분자로 나누기 </li>
</ul>

### [예외처리](https://github.com/baek-study/ie_py25/blob/main/source/week14_mju.ipynb)
<ul>
<li> try: ~  <br>
except(오류): ~ </li>
</ul>
...
## [13주차 강의&nbsp;-&nbsp;딕셔너리](https://github.com/baek-study/ie_py25/blob/main/source/week13_mju.ipynb)

### [딕셔너리 기본 구조](https://github.com/baek-study/ie_py25/blob/main/source/week13_mju.ipynb)
<ul>
...
### [딕셔너리 메소드](https://github.com/baek-study/ie_py25/blob/main/source/week13_mju.ipynb)
<ul>
<li>접근: d.get('a') </li>
...
### [딕셔너리 반복](https://github.com/baek-study/ie_py25/blob/main/source/week13_mju.ipynb)
<ul>
...
## [12주차 강의&nbsp;-&nbsp;함수와 모듈](https://github.com/baek-study/ie_py25/blob/main/source/week12_mju.ipynb)

### [인수유형 ](https://github.com/baek-study/ie_py25/blob/main/source/week12_mju.ipynb)
<ul>
...
### [함수와 리스트 ](https://github.com/baek-study/ie_py25/blob/main/source/week12_mju.ipynb)
<ul>
  <li> 매개변수로 리스트 :  </li>
...
### [지역변수vs전역변수](https://github.com/baek-study/ie_py25/blob/main/source/week12_mju.ipynb)
<ul>
...
### [모듈(module)](https://github.com/baek-study/ie_py25/blob/main/source/week12_mju.ipynb)
<ul>
...
## [4주차 강의&nbsp;-&nbsp;문자열](https://github.com/baek-study/ie_py25/blob/main/source/week4_mju.ipynb)

### [문자열 기본구조](https://github.com/baek-study/ie_py25/blob/main/source/week4_mju.ipynb)
<ul>
  <li> 생성 : msg = '안녕하세요' <br>
  - 인덱스: 첫문자에서 0부터 시작 <br>
...
### [문자열 연산/함수](https://github.com/baek-study/ie_py25/blob/main/source/week4_mju.ipynb)
<ul>
  <li> 연산 (+, *, in, == )<br>
   - 'hi'+'mju' : 문자열 결합<br>
   - 'mju'*3 : 문자열 반복<br>
...
### [서식 : f-문자열](https://github.com/baek-study/ie_py25/blob/main/source/week4_mju.ipynb)
<ul>
  <li> f'..{표현식}..' # 중괄호 사용  <br>
...
## [5주차 강의&nbsp;-&nbsp;리스트](https://github.com/baek-study/ie_py25/blob/main/source/week5_mju.ipynb)

### [리스트 기본 구조](https://github.com/baek-study/ie_py25/blob/main/source/week5_mju.ipynb)
<ul>
...
### [리스트 연산&메소드](https://github.com/baek-study/ie_py25/blob/main/source/week5_mju.ipynb)
<ul>
 <li> 연산 (+, *, in, == )<br>
   - 결합 : [1,2]+[3,4,5] <br>
   - 반복 : [1,2]*3 <br>
...
### [2차원 리스트](https://github.com/baek-study/ie_py25/blob/main/source/week5_mju.ipynb)
<ul> 
...
## [6주차 강의&nbsp;-&nbsp;조건문](https://github.com/baek-study/ie_py25/blob/main/source/week6_mju.ipynb)

### [논리 연산자](https://github.com/baek-study/ie_py25/blob/main/source/week6_mju.ipynb)
<ul>
...
### [제어문](https://github.com/baek-study/ie_py25/blob/main/source/week6_mju.ipynb)
<ul>    
...
### [단순 if(if~ - 선택 명령 1개)](https://github.com/baek-study/ie_py25/blob/main/source/week6_mju.ipynb)
<ul>    
...
### [선택 if(if~else - 선택 명령 2개)](https://github.com/baek-study/ie_py25/blob/main/source/week6_mju.ipynb)
<ul>    
  <li><b>if</b> score >= 60 <b>:</b>&ensp;<br>
    &ensp;&nbsp;  print('pass') <br>
    <b>else:</b>&ensp; <br>
...
### [연속 if 문: if ~ elif ~ else](https://github.com/baek-study/ie_py25/blob/main/source/week7_mju.ipynb)
  <ul>
...
## [9주차 강의&nbsp;-&nbsp;반복문](https://github.com/baek-study/ie_py25/blob/main/source/week9_mju.ipynb)
...
### [for 문 - 횟수 반복](https://github.com/baek-study/ie_py25/blob/main/source/week9_mju.ipynb)
<ul>
...
### [while 문 - 조건 반복](https://github.com/baek-study/ie_py25/blob/main/source/week9_mju.ipynb)
<ul>
...
## [10주차 강의&nbsp;-&nbsp;반복문2](https://github.com/baek-study/ie_py25/blob/main/source/week10_mju.ipynb)
...
### [무한 루프](https://github.com/baek-study/ie_py25/blob/main/source/week10_mju.ipynb)
<ul>
...
### [보조제어 break, continue](https://github.com/baek-study/ie_py25/blob/main/source/week10_mju.ipynb) 
<ul>
<li> break : 반복문 탈출 </li>
...
## [11주차 강의&nbsp;-&nbsp;함수1](https://github.com/baek-study/ie_py25/blob/main/source/week11_mju.ipynb)

### [함수 정의&함수 호출](https://github.com/baek-study/ie_py25/blob/main/source/week11_mju.ipynb)
<ul>
<li>함수 정의 <br>
...
### [매개변수&반환값](https://github.com/baek-study/ie_py25/blob/main/source/week11_mju.ipynb)
<ul>
